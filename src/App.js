            ...
            <div className="hero-body">
              ...
              <div className="notification is-black">
                    <div className="has-text-centered has-text-weight-bold">
                      <p>Hi, I'm <a href="https://twitter.com/ronaldlangeveld" target="_blank">Ronald</a>. I made this on the evening of 27 March 2020 after being frustrated with the instability of our internet connection.</p>
                      <p>Every 30 minutes a Speed Test is performed by my home server and results are stored onto a cloud based Database.</p>
